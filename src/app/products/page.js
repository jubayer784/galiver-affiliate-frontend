...
export default function Products() {
  ...
  return <main className="products-page shell">
    ...
    <style>{`.products-grid{display:flex;flex-wrap:nowrap;gap:12px;overflow-x:auto;padding-bottom:8px;scroll-snap-type:x proximity}.product-card{flex:0 0 220px;scroll-snap-align:start}.product-card-content{padding:10px}.product-title{font-size:13px}.product-price{margin:5px 0 3px;font-size:15px}.product-commission{margin-bottom:9px;font-size:11px}.product-link{padding:8px 6px;font-size:10px}@media(max-width:600px){.products-grid{gap:8px}.product-card{flex-basis:170px}.product-card-content{padding:8px}.product-title{font-size:12px}.product-price{font-size:14px}.product-commission{font-size:10px}.product-link{padding:7px 4px;font-size:10px}}`}</style>
