export default function UiIcon({ name, size = 18 }) {
  const paths = {
    ...
    eyeOff: <><path d="m3 3 18 18" /><path d="M10.6 6.1A10.4 10.4 0 0 1 12 6c6.5 0 10 6 10 6a18 18 0 0 1-3.1 3.7M6.2 6.2C3.5 8 2 12 2 12s3.5 6 10 6c1.3 0 2.5-.3 3.5-.7" /><path d="M9.9 9.9a3 3 0 0 0 4.2 4.2" /></>,
